(() => {
  ...
  const style=document.createElement('style');style.textContent=`
    ...
    .solo-start-overlay[data-launching="true"]{display:grid!important;place-items:center!important;align-content:center!important;overflow:hidden!important}
    .solo-start-overlay[data-launching="true"]>*:not(.solo-launch-message){display:none!important}
    ...
    .solo-start-overlay{
      ...
      padding:clamp(42px,5vh,58px) clamp(16px,3vw,42px) 30px!important;
      background:
    ...
    .main-menu-title{
      ...
      animation:mainMenuTitleGlow 4.2s ease-in-out infinite;
    }
    @keyframes mainMenuTitleGlow{0%,100%{filter:brightness(1);text-shadow:0 4px 0 rgba(105,43,18,.52),0 10px 28px rgba(0,0,0,.82),0 0 28px rgba(244,183,73,.14)}50%{filter:brightness(1.08);text-shadow:0 4px 0 rgba(105,43,18,.52),0 10px 28px rgba(0,0,0,.82),0 0 44px rgba(255,199,86,.34)}}
    .account-menu-box{
      position:relative!important;z-index:5!important;width:min(720px,90vw)!important;box-sizing:border-box;
      margin:28px auto 4px!important;padding:14px 18px 12px!important;
    ...
    .leaderboard-title h1{
      min-height:1.9em;display:grid;align-content:center;
    ...
    .leaderboard-title h1>span{display:block}
    .leaderboard-title p{min-height:1.3em;font-size:13px;margin-top:7px!important;color:#d9bc84!important}
    .leaderboard-screen.attract-mode .leaderboard-mode-tabs{visibility:hidden;pointer-events:none}
    ...
    .main-menu-floor-cards{
      display:block;position:relative;z-index:4;width:min(700px,90vw);height:112px;margin:2px auto 4px;
      pointer-events:none;filter:drop-shadow(0 14px 16px rgba(0,0,0,.44));animation:mainMenuCardGlow 5.4s ease-in-out infinite;
    }
    @keyframes mainMenuCardGlow{0%,100%{filter:drop-shadow(0 14px 16px rgba(0,0,0,.44)) drop-shadow(0 0 0 rgba(236,180,73,0))}50%{filter:drop-shadow(0 15px 18px rgba(0,0,0,.48)) drop-shadow(0 0 13px rgba(236,180,73,.16))}}
    ...
    @media(max-width:760px){
      .main-menu-floor-cards{display:block!important;width:min(94vw,520px);height:90px;margin:0 auto 3px}
      .main-menu-floor-card{width:48px}
      .main-menu-floor-card:nth-child(1){transform:translateX(-114px) translateY(7px) rotate(-21deg)}
      .main-menu-floor-card:nth-child(2){transform:translateX(-84px) translateY(5px) rotate(-14deg)}
      .main-menu-floor-card:nth-child(3){transform:translateX(-54px) translateY(2px) rotate(-7deg)}
      .main-menu-floor-card:nth-child(4){transform:translateX(-24px) translateY(0) rotate(0)}
      .main-menu-floor-card:nth-child(5){transform:translateX(6px) translateY(2px) rotate(7deg)}
      .main-menu-floor-card:nth-child(6){transform:translateX(36px) translateY(5px) rotate(14deg)}
      .main-menu-floor-card:nth-child(7){transform:translateX(66px) translateY(7px) rotate(21deg)}
      .leaderboard-screen{touch-action:pan-y}
    }
    @media(max-width:420px){
      .main-menu-floor-cards{height:82px;margin-top:0}
      .main-menu-floor-card{width:44px}
    ...
    .gostop-main-menu.main-menu-accordion{width:min(720px,90vw)!important;display:grid!important;grid-template-columns:1fr!important;gap:9px!important;margin:4px auto 0!important;padding:13px!important;border:1px solid rgba(224,180,91,.28)!important;border-radius:22px!important;background:linear-gradient(180deg,rgba(16,11,7,.66),rgba(9,7,5,.78))!important;box-shadow:0 22px 52px rgba(0,0,0,.35),inset 0 1px rgba(255,255,255,.035)!important;backdrop-filter:blur(2px)}
    ...
    .menu-category-toggle{position:relative;overflow:hidden;width:100%;min-height:72px;border-radius:12px;border:2px solid;display:flex;align-items:center;justify-content:space-between;gap:14px;padding:9px 18px;color:#fff;cursor:pointer;text-align:left;box-shadow:inset 0 1px rgba(255,255,255,.18),0 8px 18px rgba(0,0,0,.25);transition:transform .18s cubic-bezier(.22,1,.36,1),filter .18s ease,border-radius .38s cubic-bezier(.22,1,.36,1),box-shadow .24s ease}.menu-category-toggle>*{position:relative;z-index:1}.menu-category-toggle:before{content:"";position:absolute;z-index:0;top:-90%;left:-24%;width:18%;height:280%;pointer-events:none;opacity:0;background:linear-gradient(90deg,transparent,rgba(255,247,211,.34),transparent);transform:rotate(18deg);animation:mainMenuChoiceSweep 5.8s ease-in-out infinite}.menu-category-friendly:before{animation-delay:2.9s}.menu-category-toggle:hover,.menu-category-toggle:focus-visible{transform:translateY(-1px) scale(1.004);filter:brightness(1.10);outline:none;box-shadow:inset 0 1px rgba(255,255,255,.20),0 10px 22px rgba(0,0,0,.29),0 0 18px rgba(235,186,82,.10)}.menu-category-toggle:active{transform:translateY(0) scale(.994)}.menu-category-competitive{border-color:#efc66b;background:radial-gradient(circle at 20% 0%,rgba(255,224,142,.14),transparent 35%),linear-gradient(180deg,#a97628,#754617)}.menu-category-friendly{border-color:#8cc89a;background:radial-gradient(circle at 78% 0%,rgba(191,242,201,.11),transparent 35%),linear-gradient(180deg,#31693f,#234c30)}@keyframes mainMenuChoiceSweep{0%,68%{left:-24%;opacity:0}73%{opacity:.62}88%{left:112%;opacity:.42}94%,100%{left:112%;opacity:0}}
    .menu-category-copy{display:grid;gap:2px}.solo-start-overlay .menu-category-title{font:800 clamp(36px,3.05vw,42px)/.98 Georgia,serif!important;letter-spacing:0;white-space:nowrap}.menu-category-note{font:750 10px/1.1 system-ui,sans-serif;letter-spacing:.05em;opacity:.88}.menu-category-chevron{font:800 24px/1 system-ui,sans-serif;transition:transform .38s cubic-bezier(.22,1,.36,1)}.menu-category-block.expanded .menu-category-toggle{border-radius:13px 13px 8px 8px}.menu-category-block.expanded .menu-category-chevron{transform:rotate(180deg)}
    .menu-submenu{display:grid!important;grid-template-columns:1fr;gap:7px;max-height:0;opacity:0;visibility:hidden;overflow:hidden;pointer-events:none;margin:0 10px;padding:0 9px;border:1px solid transparent;border-top:0;border-radius:0 0 13px 13px;transform:translateY(-4px);will-change:max-height,opacity,transform;transition:max-height .46s cubic-bezier(.22,1,.36,1),opacity .28s ease,transform .46s cubic-bezier(.22,1,.36,1),padding .46s cubic-bezier(.22,1,.36,1),border-color .30s ease,background .30s ease,visibility 0s linear .46s}.menu-category-block.expanded .menu-submenu{max-height:var(--submenu-open-height,240px);opacity:1;visibility:visible;pointer-events:auto;transform:translateY(0);padding:8px 9px 9px;transition-delay:0s}.ranked-menu-group.expanded .menu-submenu{border-color:rgba(239,198,107,.34);background:linear-gradient(180deg,rgba(99,60,20,.44),rgba(40,24,12,.72))}.free-menu-group.expanded .menu-submenu{border-color:rgba(140,200,154,.30);background:linear-gradient(180deg,rgba(40,83,49,.46),rgba(19,43,27,.72))}.menu-submenu>button{width:100%;min-height:42px;border-radius:10px;font-size:clamp(16px,1.85vw,20px);font-weight:800}
    ...
    .leaderboard-panel{position:relative;z-index:3;width:min(1020px,88vw);max-height:min(820px,88dvh);display:grid;grid-template-rows:auto auto minmax(0,1fr) auto;gap:11px;padding:18px;border:1px solid rgba(230,187,98,.54);border-radius:20px;background:linear-gradient(180deg,rgba(24,15,10,.90),rgba(11,9,7,.90));box-shadow:0 24px 58px rgba(0,0,0,.45),inset 0 1px rgba(255,255,255,.04)}
    .leaderboard-title{padding:0!important}.leaderboard-title h1{font-size:clamp(34px,5vw,54px)!important}.leaderboard-title p{margin-top:5px!important}.leaderboard-mode-tabs{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px;width:min(540px,100%);margin:0 auto}.leaderboard-mode-tab{min-height:49px;border:1px solid rgba(222,181,95,.40);border-radius:11px;background:#2b1a11;color:#ead9b9;font:800 16px/1 system-ui,sans-serif;cursor:pointer;transition:transform .14s ease,filter .14s ease,background .18s ease,border-color .18s ease}.leaderboard-mode-tab:hover,.leaderboard-mode-tab:focus-visible{transform:translateY(-1px);filter:brightness(1.12);outline:none}.leaderboard-mode-tab.active{border-color:#efc66b;background:linear-gradient(180deg,#a7752b,#704417);color:#fff6df;box-shadow:inset 0 1px rgba(255,255,255,.18),0 7px 18px rgba(0,0,0,.24)}
    .leaderboard-table-wrap{align-self:stretch!important;width:100%!important;margin:0!important;max-height:100%!important;border-radius:13px!important}.leaderboard-table{table-layout:fixed}.leaderboard-table th:first-child,.leaderboard-table td:first-child{width:9%}.leaderboard-table th:nth-child(2),.leaderboard-table td:nth-child(2){width:26%}.leaderboard-table th:nth-child(3),.leaderboard-table td:nth-child(3){width:14%}.leaderboard-table th:nth-child(4),.leaderboard-table td:nth-child(4){width:29%}.leaderboard-table th:nth-child(5),.leaderboard-table td:nth-child(5){width:22%}.leaderboard-footer{display:grid!important;justify-items:center!important;gap:6px!important;margin:0!important}.leaderboard-return{width:min(260px,78vw);height:48px!important}.leaderboard-decor{z-index:1}.leaderboard-card-fan{opacity:.22!important}.leaderboard-controls,.leaderboard-nav{display:none!important}
    @media(max-width:760px){.solo-start-overlay{min-height:100dvh!important;align-content:center!important;place-content:center!important;overflow-y:auto!important;padding-top:max(22px,env(safe-area-inset-top))!important;padding-bottom:max(14px,env(safe-area-inset-bottom))!important}.gostop-main-menu.main-menu-accordion{width:min(94vw,560px)!important;margin-top:3px!important;padding:9px!important;gap:7px!important;border-radius:17px!important}.menu-category-toggle{min-height:56px;padding:7px 12px;border-radius:12px}.solo-start-overlay .menu-category-title{font-size:clamp(24px,6vw,30px)!important;white-space:normal}.menu-category-note{font-size:9px}.menu-category-chevron{font-size:21px}.menu-category-block.expanded .menu-category-toggle{border-radius:12px 12px 7px 7px}.menu-submenu{margin:0 7px;padding-left:7px;padding-right:7px}.menu-category-block.expanded .menu-submenu{padding:6px 7px 7px}.menu-submenu>button{min-height:40px;font-size:15px}.main-menu-utilities{gap:6px;margin-top:4px}.menu-utility{min-height:39px!important;font-size:11px!important;padding:7px 5px!important}.menu-utility:before{display:block;margin:0 0 3px;font-size:13px}.account-menu-box{width:min(94vw,560px)!important;margin-top:44px!important;margin-bottom:max(8px,env(safe-area-inset-bottom))!important}.leaderboard-screen{padding:10px!important;touch-action:pan-y}.leaderboard-screen:before{width:97vw;height:92dvh;border-width:9px;top:50%}.leaderboard-panel{width:94vw;max-height:92dvh;padding:11px;gap:8px;border-radius:16px}.leaderboard-title h1{font-size:clamp(28px,8vw,38px)!important}.leaderboard-title p{font-size:10px!important}.leaderboard-mode-tabs{gap:6px}.leaderboard-mode-tab{min-height:42px;font-size:13px}.leaderboard-table-wrap{overflow:hidden!important}.leaderboard-table{min-width:0!important;width:100%!important;table-layout:fixed}.leaderboard-table th,.leaderboard-table td{height:31px!important;padding:5px 4px!important;font-size:9px!important;white-space:normal!important;overflow:hidden;text-overflow:ellipsis}.leaderboard-table th{font-size:8px!important;line-height:1.05}.leaderboard-table th:first-child,.leaderboard-table td:first-child{width:9%}.leaderboard-table th:nth-child(2),.leaderboard-table td:nth-child(2){width:25%}.leaderboard-table th:nth-child(3),.leaderboard-table td:nth-child(3){width:13%}.leaderboard-table th:nth-child(4),.leaderboard-table td:nth-child(4){width:31%}.leaderboard-table th:nth-child(5),.leaderboard-table td:nth-child(5){width:22%}.leaderboard-return{height:43px!important}.leaderboard-attract-note{font-size:9px!important}}

    @media(max-height:760px){
      .solo-start-overlay{padding-top:max(6px,env(safe-area-inset-top))!important;padding-bottom:max(9px,env(safe-area-inset-bottom))!important;gap:3px!important;overflow-y:auto!important}
      .main-menu-title{font-size:clamp(2.15rem,9dvh,3.25rem)!important;margin-top:0!important}
      .main-menu-floor-cards{height:66px!important;margin:0 auto 1px!important;transform:scale(.84);transform-origin:center center}
      .gostop-main-menu.main-menu-accordion{margin-top:0!important;padding:7px!important;gap:5px!important}
      .menu-category-toggle{min-height:52px!important;padding:6px 10px!important}.solo-start-overlay .menu-category-title{font-size:24px!important}.menu-category-note{font-size:8px!important}
      .menu-category-block.expanded .menu-submenu{padding:5px 6px 6px!important;gap:5px!important}.menu-submenu>button{min-height:36px!important;font-size:14px!important}
  ...
  const soloLaunchMessage=document.createElement('div');soloLaunchMessage.className='solo-launch-message';soloLaunchMessage.setAttribute('role','status');soloLaunchMessage.setAttribute('aria-live','polite');overlay.appendChild(soloLaunchMessage);
  ...
  if(menuTitle)menuTitle.classList.add('main-menu-title');
  ...
  const menu=document.createElement('div');menu.className='gostop-main-menu main-menu-accordion';
  const trainingBtn=document.createElement('button');trainingBtn.type='button';trainingBtn.className='menu-training';trainingBtn.textContent='Training Mode';trainingBtn.id='trainingModeBtn';
  ...
  const leaderboardBtn=document.createElement('button');leaderboardBtn.type='button';leaderboardBtn.className='menu-utility menu-utility-leaderboards';leaderboardBtn.textContent='Leaderboards';leaderboardBtn.id='leaderboardMenuBtn';
  ...
  // Low-end Android browsers can delay or drop the synthesized click even though the
  // button visibly depresses. Activate main-menu buttons on a clean touch pointer-up,
  // then suppress only the duplicate trusted click generated by that same gesture.
  let fastMenuPointer=null,fastMenuSyntheticClick=false,fastMenuSuppressButton=null,fastMenuSuppressUntil=0;
  const fastMenuEligible=()=>globalThis.matchMedia?.('(pointer:coarse)')?.matches===true&&globalThis.innerWidth<=760;
  const mainMenuButtonFromTarget=target=>target?.closest?.('.gostop-main-menu button');
  overlay.addEventListener('pointerdown',event=>{
    if(!fastMenuEligible()||event.pointerType==='mouse')return;
    const button=mainMenuButtonFromTarget(event.target);if(!button||button.disabled)return;
    fastMenuPointer={id:event.pointerId,button,x:event.clientX,y:event.clientY,at:Date.now()};
  },{capture:true,passive:true});
  overlay.addEventListener('pointerup',event=>{
    const state=fastMenuPointer;fastMenuPointer=null;
    if(!state||state.id!==event.pointerId||state.button.disabled||!state.button.isConnected)return;
    const distance=Math.hypot(event.clientX-state.x,event.clientY-state.y),elapsed=Date.now()-state.at;
    if(distance>14||elapsed>900)return;
    event.preventDefault();
    fastMenuSuppressButton=state.button;fastMenuSuppressUntil=Date.now()+350;
    fastMenuSyntheticClick=true;
    try{state.button.click();}finally{fastMenuSyntheticClick=false;}
  },{capture:true,passive:false});
  overlay.addEventListener('pointercancel',()=>{fastMenuPointer=null;},{capture:true});
  overlay.addEventListener('click',event=>{
    if(fastMenuSyntheticClick)return;
    const button=mainMenuButtonFromTarget(event.target);
    if(button&&button===fastMenuSuppressButton&&Date.now()<fastMenuSuppressUntil){
  ...
  const onlinePanel=document.createElement('section');onlinePanel.id='onlineLobbyPanel';onlinePanel.className='online-lobby-panel';onlinePanel.hidden=true;onlinePanel.innerHTML=`<div class="online-lobby-card"><h2>Online Play</h2><div class="online-method" data-online-section="matchmaking"><strong>Matchmaking Lobby</strong><p class="account-help">Auto Match requests the closest skill match, or Browse Top 10 to choose from the ten closest available players.</p><div class="online-match-actions"><button id="autoMatchBtn" class="auto-match-primary" type="button">Auto Match</button><button id="autoMatchCancelBtn" type="button" hidden>Cancel Auto Match</button><button id="browsePlayersBtn" type="button">Browse Top 10</button><button id="searchPlayersBtn" type="button">Search Player</button><span id="onlinePlayerCount" class="online-count">0 online</span></div><div id="browsePlayerResults" class="online-player-list" hidden></div></div><div class="online-method" data-online-section="search" hidden><strong>Search Player</strong><div class="online-search-row"><input id="onlineNicknameSearch" autocomplete="off" placeholder="Nickname"><button id="onlineNicknameSearchBtn" type="button">Search</button></div><div id="searchPlayerResults" class="online-player-list" hidden></div></div><p id="lobbyStatus" class="lobby-status" role="status" aria-live="polite"></p><div class="online-lobby-actions"><button id="onlineLobbyClose" type="button">Return</button></div></div>`;document.body.appendChild(onlinePanel);
  if(createRoom){createRoom.hidden=true;createRoom.style.display='none';}if(joinForm){joinForm.hidden=true;joinForm.style.display='none';}
  ...
  const friendlyInviterDialog=document.createElement('dialog');friendlyInviterDialog.className='ranked-flow-dialog gostop-account-dialog';friendlyInviterDialog.innerHTML=`<div class="dialog-card account-dialog-card"><h2 id="friendlyInviterTitle">Friend Sign Up Bonus</h2><p id="friendlyInviterText"></p><div class="decision-actions"><button id="friendlyInviterFriend" class="glass-btn" type="button" hidden>Add Friend</button><button id="friendlyInviterAction" class="go-btn" type="button">OK</button></div></div>`;document.body.appendChild(friendlyInviterDialog);
  const notificationBlockedDialog=document.createElement('dialog');notificationBlockedDialog.id='notificationBlockedDialog';notificationBlockedDialog.className='gostop-account-dialog';notificationBlockedDialog.innerHTML=`<div class="dialog-card account-dialog-card"><h2 id="notificationBlockedTitle">Notifications Blocked</h2><p id="notificationBlockedText" class="account-help"></p><p id="notificationBlockedSteps" class="account-help"></p><label class="notification-permission-check"><input id="notificationBlockedReady" type="checkbox"> <span id="notificationBlockedReadyLabel">I changed Notifications for this site to Allow</span></label><p id="notificationBlockedStatus" class="account-error" role="status"></p><div class="decision-actions"><button id="notificationBlockedRetry" class="go-btn" type="button" disabled>Check Again &amp; Enable</button><button id="notificationBlockedCancel" class="glass-btn" type="button">Cancel</button></div></div>`;document.body.appendChild(notificationBlockedDialog);
  ...
  const leaderboardScreen=document.createElement('section');leaderboardScreen.className='leaderboard-screen';leaderboardScreen.hidden=true;leaderboardScreen.innerHTML=`<div class="leaderboard-decor" aria-hidden="true"></div><div class="leaderboard-panel"><header class="leaderboard-title"><h1 id="leaderboardHeading">Global Leaderboard</h1><p id="leaderboardSubheading"></p></header><nav class="leaderboard-mode-tabs" aria-label="Leaderboard view"><button id="globalLeaderboardTab" class="leaderboard-mode-tab active" type="button" aria-selected="true">Global</button><button id="monthlyLeaderboardTab" class="leaderboard-mode-tab" type="button" aria-selected="false">Monthly</button></nav><div class="leaderboard-table-wrap"><table class="leaderboard-table"><thead><tr><th>Rank</th><th>Nickname</th><th>Net Coins</th><th>Earned / Lost</th><th>Games Played</th></tr></thead><tbody id="leaderboardBody"></tbody></table></div><footer class="leaderboard-footer"><p class="leaderboard-attract-note" id="leaderboardAttractNote"></p><button class="leaderboard-return" type="button">Return</button></footer></div>`;document.body.appendChild(leaderboardScreen);
  ...
  function showFriendlyInviterDialog(title,text,action='ok',buttonText='OK'){
    $('friendlyInviterTitle').textContent=title;$('friendlyInviterText').textContent=text;const button=$('friendlyInviterAction'),friendButton=$('friendlyInviterFriend');button.dataset.action=action;button.textContent=buttonText;button.hidden=action==='waiting';button.disabled=false;friendButton.hidden=true;delete friendButton.dataset.accountId;if(!friendlyInviterDialog.open)friendlyInviterDialog.showModal();
  }
  function maybeShowFriendlyReferralNotice(){
    ...
    if(notice.type==='friendly-referral-signup-complete'){
      showFriendlyInviterDialog('Thank You!',`Thank you! Your friend has signed up. Your friend's ID is ${friend}. ${friend} received 200 bonus Coins. Your 200 bonus Coins will be ready after ${friend} completes 10 Competitive games outside games played with you.`,'ack','OK');const friendButton=$('friendlyInviterFriend');friendButton.hidden=!notice.friendAccountId;friendButton.dataset.accountId=notice.friendAccountId||'';friendButton.textContent=`Add ${friend} as Friend`;return true;
    }
  ...
  function applyRankedLocale(){
    ...
    const lobbyCard=onlinePanel.querySelector('.online-lobby-card'),methods=onlinePanel.querySelectorAll('.online-method');if(lobbyCard?.querySelector('h2'))lobbyCard.querySelector('h2').textContent=rt('online');if(methods[0]){methods[0].querySelector('strong').textContent=rt('findOnline');methods[0].querySelector('p').textContent=rt('findOnlineHelp');$('autoMatchBtn').textContent=rt('autoMatch');$('autoMatchCancelBtn').textContent=rt('cancelAutoMatch');$('browsePlayersBtn').textContent=rt('browsePlayers');$('searchPlayersBtn').textContent=rt('searchPlayer');syncNotificationButton();}if(methods[1]){methods[1].querySelector('strong').textContent=rt('searchPlayer');$('onlineNicknameSearch').placeholder=rt('nickname');$('onlineNicknameSearchBtn').textContent=rt('search');}$('onlineLobbyClose').textContent=rt('return');renderLobbyPresence(lastLobbyPlayers,lastLobbyOnlineCount);if(lobbySearchActive)renderPlayers(lastSearchPlayers,'searchPlayerResults');
    $('settingsTitle').textContent='Settings';$('settingsOk').textContent='OK';renderNotificationBlockedDialog();syncNotificationButton();
  ...
  function showAccountSuccess(kind='registered',data=null){
    ...
    successDialog.dataset.kind=kind;successDialog.dataset.referralCoins=String(referralCoins);successDialog.dataset.referralAttempted=referralAttempted?'1':'0';successDialog.dataset.referralStage=stage;successDialog.dataset.friendAccountId=inviterId;applyRankedLocale();
    const friendBtn=$('registrationAddFriend');friendBtn.hidden=!inviterId;friendBtn.textContent=inviterId?`Add ${inviterName} as Friend`:'Add Inviter as Friend';
  ...
  function focusCompetitiveGaming(){revealCurrentMainMenu();setMenuSection('competitive');rankedGroup.classList.add('referral-focus');rankedGroup.scrollIntoView?.({block:'center',behavior:'smooth'});rankedSolo.focus?.();setTimeout(()=>rankedGroup.classList.remove('referral-focus'),4500);}
  async function finishFriendlySignupSuccess(goCompetitive=false){
    ...
    successDialog.close();delete successDialog.dataset.kind;delete successDialog.dataset.referralCoins;delete successDialog.dataset.referralAttempted;delete successDialog.dataset.referralStage;delete successDialog.dataset.friendAccountId;$('registrationCompetitive').hidden=true;$('registrationAddFriend').hidden=true;
  ...
  function setSoloLaunchCover(active){
    if(active){overlay.dataset.launching='true';soloLaunchMessage.textContent=rt('starting');overlay.hidden=false;return;}
    delete overlay.dataset.launching;soloLaunchMessage.textContent='';
  }
  ...
  onlinePlay.addEventListener('click',()=>beginRankedEntry('online',async()=>{
    ...
    autoMatchSearching=false;browsePlayersActive=false;lobbySearchActive=false;lastSearchPlayers=[];pendingLobbyMessage=null;syncAutoMatchControls();$('browsePlayerResults').hidden=true;$('searchPlayerResults').hidden=true;const searchSection=onlinePanel.querySelector('[data-online-section="search"]');if(searchSection)searchSection.hidden=true;$('onlineNicknameSearch').value='';$('lobbyStatus').textContent='';
  ...
  function leaderboardRowHtml(row,{current=false,outsideTop=false}={}){
    ...
    return `<tr class="${classes}"><td>${rankNumberHtml(row.rank)}</td><td>${flagEmoji(row.countryCode)} ${playerNicknameHtml(row)}</td><td>${fmtScore(row.netCoins??row.score)}</td><td>${Number(row.totalCoins)||0} / ${Number(row.totalCoinsLost)||0}</td><td>${Number(row.gamesPlayed)||0}</td></tr>`;
  }
  ...
  function setLeaderboardHeading(text){
    const heading=$('leaderboardHeading'),words=String(text||'').trim().split(/\s+/).filter(Boolean);
  ...
  function renderLeaderboard(){
    ...
    setLeaderboardHeading(leaderboardPage===0?rt('global'):rt('monthly'));$('leaderboardSubheading').textContent=leaderboardPage===0?rt('globalSub'):rt('monthToDate',{month:leaderboardData?.month||rt('currentMonth')});$('leaderboardAttractNote').textContent=attractMode?rt('attractNote'):'';const globalTab=$('globalLeaderboardTab'),monthlyTab=$('monthlyLeaderboardTab'),modeTabs=leaderboardScreen.querySelector('.leaderboard-mode-tabs');if(modeTabs){modeTabs.setAttribute('aria-hidden',attractMode?'true':'false');}if(globalTab&&monthlyTab){globalTab.classList.toggle('active',leaderboardPage===0);monthlyTab.classList.toggle('active',leaderboardPage===1);globalTab.setAttribute('aria-selected',leaderboardPage===0?'true':'false');monthlyTab.setAttribute('aria-selected',leaderboardPage===1?'true':'false');globalTab.tabIndex=attractMode?-1:0;monthlyTab.tabIndex=attractMode?-1:0;}
  ...
  function playerAccountId(player){return String(player?.accountId||player?.id||'').trim();}
  function playerNicknameHtml(player){
    const name=String(player?.nickname||rt('playerFallback')),id=playerAccountId(player);
    if(!id)return escapeHtml(name);
    return `<button type="button" class="player-nickname-link" data-player-info-account-id="${escapeHtml(id)}" data-player-info-nickname="${escapeHtml(name)}">${escapeHtml(name)}</button>`;
  }
  function playerSentenceHtml(text,player){
    const sentence=String(text||''),name=String(player?.nickname||''),index=name?sentence.indexOf(name):-1;
    if(index<0||!playerAccountId(player))return escapeHtml(sentence);
    return `${escapeHtml(sentence.slice(0,index))}${playerNicknameHtml(player)}${escapeHtml(sentence.slice(index+name.length))}`;
  }
  function signedCoins(value){const amount=Math.trunc(Number(value)||0);return `${amount>0?'+':''}${amount}`;}
  function profileDate(value){if(!value)return '—';const parsed=new Date(value);return Number.isFinite(parsed.getTime())?parsed.toLocaleDateString(undefined,{year:'numeric',month:'short',day:'numeric'}):'—';}
  function playerInfoStat(label,value){return `<div class="player-info-stat"><span>${escapeHtml(label)}</span><strong>${value}</strong></div>`;}
  function closePlayerInfoDialog(){if(playerInfoDialog.open)playerInfoDialog.close();}
  async function openPlayerInfo(accountId,nickname='Player'){
    const id=String(accountId||'').trim();if(!id)return;
    if(attractMode){attractMode=false;if(leaderboardTimer)clearTimeout(leaderboardTimer);leaderboardTimer=null;}
    $('playerInfoTitle').textContent=nickname||'Player Info';$('playerInfoBody').innerHTML='<p class="account-help">Loading player information…</p>';
    if(!playerInfoDialog.open)playerInfoDialog.showModal();
    try{
      const data=await api('/api/player-profile',{method:'POST',body:{accountId:id}}),p=data.player||{},history=p.headToHead||{},self=String(account?.id||'')===String(p.accountId||id);
      const globalRank=rankNumberHtml(p.globalRank??p.rank),monthlyRank=rankNumberHtml(p.monthlyRank),net=Number.isFinite(Number(history.netCoins))?Number(history.netCoins):(Number(history.coinsWon)||0)-(Number(history.coinsLost)||0);
      $('playerInfoTitle').innerHTML=`${flagEmoji(p.countryCode)} ${escapeHtml(p.nickname||nickname||rt('playerFallback'))}`;
      const career=[
        playerInfoStat('Global Rank',globalRank),
        playerInfoStat('Monthly Rank',monthlyRank),
        playerInfoStat('Sessions Played',escapeHtml(String(Number(p.sessionsPlayed)||0))),
        playerInfoStat('Games Played',escapeHtml(String(Number(p.gamesPlayed)||0))),
        playerInfoStat('Games Won',escapeHtml(String(Number(p.wins)||0))),
        playerInfoStat('Games Lost',escapeHtml(String(Number(p.losses)||0))),
        playerInfoStat('Last Logged In',escapeHtml(profileDate(p.lastLoginAt))),
        playerInfoStat('Wallet Coins',`🪙 ${escapeHtml(String(Number(p.walletCoins)||0))}`)
      ].join('');
      const together=self?'':`<div class="player-info-section-title">Your History With ${escapeHtml(p.nickname||nickname||'Player')}</div><div class="player-info-grid">${[
        playerInfoStat('Sessions With You',escapeHtml(String(Number(history.sessionsPlayedTogether)||0))),
        playerInfoStat('Games With You',escapeHtml(String(Number(history.gamesPlayedTogether)||0))),
        playerInfoStat('Your Wins',escapeHtml(String(Number(history.wins)||0))),
        playerInfoStat('Your Losses',escapeHtml(String(Number(history.losses)||0))),
        playerInfoStat('Coins vs This Player',`🪙 ${escapeHtml(signedCoins(net))}`)
      ].join('')}</div><p class="player-info-help">A positive Coin number means you are ahead against this player. A negative number means you are behind.</p>`;
      $('playerInfoBody').innerHTML=`<div class="player-info-section-title">Player Stats</div><div class="player-info-grid">${career}</div>${together}`;
    }catch(error){$('playerInfoBody').innerHTML=`<p class="account-error">${escapeHtml(localizedError(error))}</p>`;}
  }
  ...
  function socialActionButtons(player){
    ...
    else if(state==='incoming'||p.requestDirection==='incoming'){buttons.push(`<button type="button" class="social-action primary" data-social-action="accept" data-account-id="${escapeHtml(p.accountId)}" data-nickname="${escapeHtml(p.nickname||'Player')}">Accept</button>`);buttons.push(`<button type="button" class="social-action danger" data-social-action="decline" data-account-id="${escapeHtml(p.accountId)}" data-nickname="${escapeHtml(p.nickname||'Player')}">Decline</button>`);}
    else if(state==='outgoing'||p.requestDirection==='outgoing')buttons.push(`<button type="button" class="social-action" data-social-action="cancel" data-account-id="${escapeHtml(p.accountId)}" data-nickname="${escapeHtml(p.nickname||'Player')}">Cancel Request</button>`);
    else buttons.push(`<button type="button" class="social-action" data-social-action="add" data-account-id="${escapeHtml(p.accountId)}" data-nickname="${escapeHtml(p.nickname||'Player')}">Add Friend</button>`);
    return buttons.join('');
  }
  ...
  async function handleSocialAction(action,accountId,nickname){
    ...
    try{
      let result=null;
      if(action==='add')result=await api('/api/social/request',{method:'POST',body:{accountId}});
      else if(action==='accept')result=await api('/api/social/respond',{method:'POST',body:{accountId,accept:true}});
      else if(action==='decline')result=await api('/api/social/respond',{method:'POST',body:{accountId,accept:false}});
      else if(action==='unfriend'||action==='cancel')result=await api('/api/social/unfriend',{method:'POST',body:{accountId}});
      notifySocialChanged(accountId);await refreshAccount();await refreshSocial();
      if(action==='add'&&result?.state==='outgoing')showFriendRequestSentDialog(nickname);
      else showToast(action==='accept'||action==='add'&&result?.state==='friend'?'Friend added.':action==='unfriend'?'Friend removed.':action==='decline'||action==='cancel'?'Friend Request removed.':'Friend Request sent.',2200);
  ...
  function renderMissedRequestDialog(){
    ...
    $('missedRequestText').innerHTML=playerSentenceHtml(rt('missedRequestText',{name}),item.from);
  ...
  function showOutgoingRequest(message){
    ...
    $('cancelOutgoingRequest').textContent=rt('cancelRequest');$('cancelOutgoingRequest').disabled=!message.requestId&&!message.automatic;
    if(!outgoingRequestDialog.open)outgoingRequestDialog.showModal();
  }
  function showAutoMatchWaiting(){
    pendingOutgoingRequest={requestId:null,automatic:true,to:null};$('outgoingRequestTitle').textContent='Looking for Another Player';$('outgoingRequestText').textContent='No other available players right now. Auto Match will wait for another player to become available.';renderOpponentProfile('outgoingOpponentProfile',null);$('cancelOutgoingRequest').textContent=rt('cancelAutoMatch');$('cancelOutgoingRequest').disabled=false;if(!outgoingRequestDialog.open)outgoingRequestDialog.showModal();
  }
  ...
  function handleLobbyMessage(message){
    ...
    if(message.type==='playRequest'){
      ...
      $('requestPlayerName').innerHTML=`${flagEmoji(from.countryCode)} ${playerSentenceHtml(rt('wantsPlay',{name}),from)}`;
  ...
  $('friendRequestSentOk').addEventListener('click',()=>friendRequestSentDialog.close());
  $('playerInfoOk').addEventListener('click',closePlayerInfoDialog);playerInfoDialog.addEventListener('click',closePlayerInfoDialog);
  document.addEventListener('click',event=>{const target=event.target.closest?.('[data-player-info-account-id]');if(!target)return;event.preventDefault();event.stopImmediatePropagation();void openPlayerInfo(target.dataset.playerInfoAccountId,target.dataset.playerInfoNickname||target.textContent.trim());},{capture:true});
  ...
  $('browsePlayersBtn').addEventListener('click',()=>{browsePlayersActive=true;lobbySearchActive=false;const searchSection=onlinePanel.querySelector('[data-online-section="search"]');if(searchSection)searchSection.hidden=true;$('searchPlayerResults').hidden=true;$('browsePlayerResults').hidden=false;$('lobbyStatus').textContent='';sendLobbyMessage({type:'recommendations'});});
  $('searchPlayersBtn').addEventListener('click',()=>{browsePlayersActive=false;$('browsePlayerResults').hidden=true;const searchSection=onlinePanel.querySelector('[data-online-section="search"]');if(searchSection)searchSection.hidden=false;const query=$('onlineNicknameSearch').value.trim();lobbySearchActive=!!query;$('searchPlayerResults').hidden=!query;if(query)sendLobbyMessage({type:'search',query},'lobbyConnecting');$('onlineNicknameSearch').focus();$('lobbyStatus').textContent='';});
  ...
  async function showRoomShareLink(roomCode,mode){
    if(mode!=='free')return;const box=$('freeShareLinkBox'),link=$('freeShareLink');if(!box||!link)return;
    ...
    const url=roomShareUrl(roomCode,'free',referralToken);link.href=url;link.textContent=url;box.hidden=false;
  }
  ...
  async function copyFriendlyShareLink(){
    const link=$('freeShareLink');if(!link?.href)return;try{await navigator.clipboard.writeText(link.href);showLinkCopiedDialog();}catch(_){showToast(link.href,5000);}
  }
  ...
  $('freeShareBtn').addEventListener('click',()=>{void shareFriendlyInvite();});$('freeCopyLinkBtn').addEventListener('click',()=>copyFriendlyShareLink());
  globalThis.addEventListener('gostop-online-room-created',event=>{const roomCode=event.detail?.room?.roomCode;if(!roomCode||pendingChallengeCreate||event.detail?.adapter?.anonymous!==true)return;void showRoomShareLink(roomCode,'free');});
  ...
  function patchGameIdentity(){
    ...
    if(account){humanName.innerHTML=playerNicknameHtml({accountId:account.id,nickname:account.nickname,countryCode:account.countryCode});const line=ensureWalletLine(humanIdentity,'ranked-human-wallet');if(line)line.textContent=`🪙 ${coinText(displayedWalletCoins())}`;}
    else {humanName.textContent=rt('you');humanIdentity?.querySelector('.ranked-human-wallet')?.remove();}
    if(currentSnapshot?.ranked&&currentSnapshot.opponentProfile){const opponent=currentSnapshot.opponentProfile;if(rankedMode==='solo'||opponent.bot){opponentName.textContent=rt('computer',{level:opponent.computerLevel||1});}else{const row=gameRow(opponent.nickname),rank=row?rankLabelHtml(row.rank):escapeHtml(rt('unranked'));opponentName.innerHTML=`${playerNicknameHtml(opponent)} · ${rank}`;}const line=ensureWalletLine(opponentIdentity,'ranked-opponent-wallet');if(line)line.textContent=`🪙 ${coinText(opponent.walletCoins)}`;}else if(!currentSnapshot){opponentIdentity?.querySelector('.ranked-opponent-wallet')?.remove();}
  }
