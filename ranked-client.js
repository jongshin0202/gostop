(() => {
  ...
  const style=document.createElement('style');style.textContent=`
    ...
    .main-menu-floor-cards{
      ...
      pointer-events:none;filter:drop-shadow(0 14px 16px rgba(0,0,0,.44));
    }
    ...
    .menu-category-toggle{width:100%;min-height:62px;border-radius:15px;border:2px solid;display:flex;align-items:center;justify-content:space-between;gap:16px;padding:12px 18px;color:#fff;cursor:pointer;text-align:left;box-shadow:inset 0 1px rgba(255,255,255,.18),0 10px 22px rgba(0,0,0,.28);transition:transform .16s ease,filter .16s ease,border-radius .28s ease,box-shadow .2s ease}.menu-category-toggle:hover,.menu-category-toggle:focus-visible{transform:translateY(-2px);filter:brightness(1.08);outline:none}.menu-category-competitive{border-color:#efc66b;background:linear-gradient(180deg,#ae7927,#774719)}.menu-category-friendly{border-color:#8cc89a;background:linear-gradient(180deg,#326a40,#234d30)}
    .menu-category-copy{display:grid;gap:4px}.menu-category-title{font:800 clamp(23px,3vw,31px)/1.05 Georgia,serif}.menu-category-note{font:700 11px/1.2 system-ui,sans-serif;letter-spacing:.05em;opacity:.88}.menu-category-chevron{font:800 27px/1 system-ui,sans-serif;transition:transform .28s ease}.menu-category-block.expanded .menu-category-toggle{border-radius:15px 15px 9px 9px}.menu-category-block.expanded .menu-category-chevron{transform:rotate(180deg)}
    .menu-submenu{display:grid!important;grid-template-columns:1fr;gap:9px;max-height:0;opacity:0;visibility:hidden;overflow:hidden;pointer-events:none;margin:0 12px;padding:0 10px;border:1px solid transparent;border-top:0;border-radius:0 0 15px 15px;transform:translateY(-6px);transition:max-height .34s cubic-bezier(.2,.8,.2,1),opacity .22s ease,transform .34s ease,padding .34s ease,border-color .25s ease,background .25s ease,visibility 0s linear .34s}.menu-category-block.expanded .menu-submenu{max-height:260px;opacity:1;visibility:visible;pointer-events:auto;transform:translateY(0);padding:11px 10px 12px;transition-delay:0s}.ranked-menu-group.expanded .menu-submenu{border-color:rgba(239,198,107,.34);background:linear-gradient(180deg,rgba(99,60,20,.44),rgba(40,24,12,.72))}.free-menu-group.expanded .menu-submenu{border-color:rgba(140,200,154,.30);background:linear-gradient(180deg,rgba(40,83,49,.46),rgba(19,43,27,.72))}.menu-submenu>button{width:100%;min-height:46px;border-radius:11px;font-size:clamp(18px,2.2vw,23px);font-weight:800}
    ...
    @media(max-width:760px){.gostop-main-menu.main-menu-accordion{width:min(94vw,560px)!important;margin-top:2px!important;padding:9px!important;gap:7px!important;border-radius:17px!important}.menu-category-toggle{min-height:55px;padding:8px 12px;border-radius:13px}.menu-category-title{font-size:clamp(20px,6vw,25px)}.menu-category-note{font-size:9px}.menu-category-chevron{font-size:23px}.menu-category-block.expanded .menu-category-toggle{border-radius:13px 13px 8px 8px}.menu-submenu{margin:0 7px;padding-left:7px;padding-right:7px}.menu-category-block.expanded .menu-submenu{padding:7px 7px 8px;max-height:220px}.menu-submenu>button{min-height:43px;font-size:16px}.main-menu-utilities{gap:5px}.menu-utility{min-height:38px!important;font-size:11px!important;padding:7px 5px!important}.menu-utility:before{display:block;margin:0 0 3px;font-size:13px}.leaderboard-screen{padding:10px!important;touch-action:pan-y}.leaderboard-screen:before{width:97vw;height:92dvh;border-width:9px;top:50%}.leaderboard-panel{width:94vw;max-height:92dvh;padding:11px;gap:8px;border-radius:16px}.leaderboard-title h1{font-size:clamp(28px,8vw,38px)!important}.leaderboard-title p{font-size:10px!important}.leaderboard-mode-tabs{gap:6px}.leaderboard-mode-tab{min-height:42px;font-size:13px}.leaderboard-table-wrap{overflow:hidden!important}.leaderboard-table{min-width:0!important;width:100%!important;table-layout:fixed}.leaderboard-table th,.leaderboard-table td{height:31px!important;padding:5px 4px!important;font-size:9px!important;white-space:normal!important;overflow:hidden;text-overflow:ellipsis}.leaderboard-table th{font-size:8px!important;line-height:1.05}.leaderboard-table th:first-child,.leaderboard-table td:first-child{width:9%}.leaderboard-table th:nth-child(2),.leaderboard-table td:nth-child(2){width:25%}.leaderboard-table th:nth-child(3),.leaderboard-table td:nth-child(3){width:13%}.leaderboard-table th:nth-child(4),.leaderboard-table td:nth-child(4){width:31%}.leaderboard-table th:nth-child(5),.leaderboard-table td:nth-child(5){width:22%}.leaderboard-return{height:43px!important}.leaderboard-attract-note{font-size:9px!important}}

    @media(max-height:760px){
      .solo-start-overlay{padding-top:max(5px,env(safe-area-inset-top))!important;padding-bottom:max(7px,env(safe-area-inset-bottom))!important;gap:2px!important;overflow:hidden!important}
      .main-menu-title{font-size:clamp(2.15rem,9dvh,3.25rem)!important;margin-top:0!important}
      .main-menu-floor-cards{height:70px!important;margin:0 auto 1px!important;transform:scale(.88);transform-origin:center center}
      .gostop-main-menu.main-menu-accordion{margin-top:0!important;padding:7px!important;gap:5px!important}
      .menu-category-toggle{min-height:48px!important;padding:6px 10px!important}.menu-category-title{font-size:20px!important}.menu-category-note{font-size:8px!important}
      .menu-category-block.expanded .menu-submenu{padding:5px 6px 6px!important;gap:5px!important}.menu-submenu>button{min-height:38px!important;font-size:15px!important}
      .main-menu-utilities{gap:4px!important}.menu-utility{min-height:34px!important;padding:4px!important}
      .account-menu-box{padding:7px 10px!important;margin-top:3px!important}
    }
  ...
  function setMenuSection(section=null){
    ...
    for(const [name,group,toggle,submenu] of [['competitive',rankedGroup,rankedToggle,rankedSubmenu],['friendly',freeGroup,freeToggle,freeSubmenu]]){
      const open=expandedMenuSection===name;group.classList.toggle('expanded',open);toggle.setAttribute('aria-expanded',open?'true':'false');submenu.setAttribute('aria-hidden',open?'false':'true');submenu.inert=!open;
    }
  }
