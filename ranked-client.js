(() => {
  ...
  const style=document.createElement('style');style.textContent=`
    ...
    .account-menu-box{
      ...
      margin:14px auto 4px!important;padding:14px 18px 12px!important;
    ...
    @media(max-height:760px){
      ...
      .menu-category-toggle{min-height:38px!important;padding:5px 9px!important}.solo-start-overlay .menu-category-title{font-size:14px!important}.menu-category-note{font-size:7px!important}
      ...
      .account-menu-box{padding:7px 10px!important;margin-top:9px!important}
    }
  ...
  function renderLeaderboard(){
    ...
    $('leaderboardHeading').textContent=leaderboardPage===0?rt('global'):rt('monthly');$('leaderboardSubheading').textContent=leaderboardPage===0?rt('globalSub'):rt('monthToDate',{month:leaderboardData?.month||rt('currentMonth')});$('leaderboardAttractNote').textContent=attractMode?rt('attractNote'):'';const globalTab=$('globalLeaderboardTab'),monthlyTab=$('monthlyLeaderboardTab');if(globalTab&&monthlyTab){globalTab.classList.toggle('active',leaderboardPage===0);monthlyTab.classList.toggle('active',leaderboardPage===1);globalTab.setAttribute('aria-selected',leaderboardPage===0?'true':'false');monthlyTab.setAttribute('aria-selected',leaderboardPage===1?'true':'false');}
