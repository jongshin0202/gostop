(() => {
  ...
  const style=document.createElement('style');style.textContent=`
    ...
    @media(max-height:760px){
      ...
      .menu-category-toggle{min-height:38px!important;padding:5px 9px!important}.menu-category-title{font-size:16px!important}.menu-category-note{font-size:7px!important}
