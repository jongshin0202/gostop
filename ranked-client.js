(() => {
  ...
  const style=document.createElement('style');style.textContent=`
    ...
    .gostop-main-menu.main-menu-accordion{width:min(720px,90vw)!important;display:grid!important;grid-template-columns:1fr!important;gap:12px!important;margin:18px auto 0!important;padding:18px!important;border:1px solid rgba(224,180,91,.28)!important;border-radius:22px!important;background:linear-gradient(180deg,rgba(16,11,7,.66),rgba(9,7,5,.78))!important;box-shadow:0 22px 52px rgba(0,0,0,.35),inset 0 1px rgba(255,255,255,.035)!important;backdrop-filter:blur(2px)}
    ...
    .menu-category-toggle{width:100%;min-height:74px;border-radius:15px;border:2px solid;display:flex;align-items:center;justify-content:space-between;gap:16px;padding:12px 18px;color:#fff;cursor:pointer;text-align:left;box-shadow:inset 0 1px rgba(255,255,255,.18),0 10px 22px rgba(0,0,0,.28);transition:transform .16s ease,filter .16s ease,border-radius .28s ease,box-shadow .2s ease}.menu-category-toggle:hover,.menu-category-toggle:focus-visible{transform:translateY(-2px);filter:brightness(1.08);outline:none}.menu-category-competitive{border-color:#efc66b;background:linear-gradient(180deg,#ae7927,#774719)}.menu-category-friendly{border-color:#8cc89a;background:linear-gradient(180deg,#326a40,#234d30)}
    ...
    .menu-submenu{display:grid!important;grid-template-columns:1fr;gap:9px;max-height:0;opacity:0;overflow:hidden;pointer-events:none;margin:0 12px;padding:0 10px;border:1px solid transparent;border-top:0;border-radius:0 0 15px 15px;transform:translateY(-6px);transition:max-height .34s cubic-bezier(.2,.8,.2,1),opacity .22s ease,transform .34s ease,padding .34s ease,border-color .25s ease,background .25s ease}.menu-category-block.expanded .menu-submenu{max-height:260px;opacity:1;pointer-events:auto;transform:translateY(0);padding:11px 10px 12px}.ranked-menu-group.expanded .menu-submenu{border-color:rgba(239,198,107,.34);background:linear-gradient(180deg,rgba(99,60,20,.44),rgba(40,24,12,.72))}.free-menu-group.expanded .menu-submenu{border-color:rgba(140,200,154,.30);background:linear-gradient(180deg,rgba(40,83,49,.46),rgba(19,43,27,.72))}.menu-submenu>button{width:100%;min-height:55px;border-radius:11px;font-size:clamp(18px,2.2vw,23px);font-weight:800}
  ...
  const rankedSubmenu=document.createElement('div');rankedSubmenu.id='competitiveGamingSubmenu';rankedSubmenu.className='menu-submenu competitive-submenu';rankedSubmenu.setAttribute('aria-hidden','true');rankedSubmenu.append(rankedSolo,onlinePlay);rankedGroup.append(rankedToggle,rankedSubmenu);
  ...
  const freeSubmenu=document.createElement('div');freeSubmenu.id='friendlyGamingSubmenu';freeSubmenu.className='menu-submenu friendly-submenu';freeSubmenu.setAttribute('aria-hidden','true');freeSubmenu.append(playPractice,freeFriendBtn,trainingBtn);freeGroup.append(freeToggle,freeSubmenu);
  ...
  function setMenuSection(section=null){
    ...
    for(const [name,group,toggle,submenu] of [['competitive',rankedGroup,rankedToggle,rankedSubmenu],['friendly',freeGroup,freeToggle,freeSubmenu]]){
      const open=expandedMenuSection===name;group.classList.toggle('expanded',open);toggle.setAttribute('aria-expanded',open?'true':'false');submenu.setAttribute('aria-hidden',open?'false':'true');
    }
  }
