(() => {
  ...
  const style=document.createElement('style');style.textContent=`
    ...
    @media(max-height:760px){
      ...
      .menu-category-toggle{min-height:43px!important;padding:5px 10px!important}.menu-category-title{font-size:18px!important}.menu-category-note{font-size:7px!important}
