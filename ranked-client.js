(() => {
  ...
  const style=document.createElement('style');style.textContent=`
    ...
    @media(max-height:760px){
      ...
      .account-menu-box{padding:7px 10px!important;margin-top:16px!important}
    }
