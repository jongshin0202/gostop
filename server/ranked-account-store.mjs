...
export class AccountStore extends BaseAccountStore{
  ...
  async forceQuit(request){
    ...
    if(settlementType!=='nagari'){const quitterStats=ensureStats(account,month);for(const stats of quitterStats){stats.gamesPlayed+=1;stats.losses=(Number(stats.losses)||0)+1;}addMilestones(quitterStats,body.quitterMilestones);}
