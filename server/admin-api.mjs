...
async function editProfile(store,request,id,body){
  const reason=reasonOf(body),account=await store.accountById(id);if(!account)return json({ok:false,error:{code:'ACCOUNT_NOT_FOUND',message:'Account not found.'}},404),before=safeAccount(account);
