...
test('fullscreen integration preserves gameplay click propagation while splash touch owns only its start gesture',()=>{
  ...
  assert.match(index,/<script src="runtime-config\.js\?v=20260925-6"><\/script>[\s\S]*<script src="mobile-fullscreen\.js\?v=20260925-9"><\/script>[\s\S]*<script src="ranked-client\.js\?v=20260926-27"><\/script>/);
