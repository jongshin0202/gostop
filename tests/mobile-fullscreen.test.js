...
test('fullscreen integration preserves gameplay click propagation while splash touch owns only its start gesture',()=>{
  ...
  assert.match(index,/<script src="runtime-config\.js\?v=20260924-5"><\/script>[\s\S]*<script src="mobile-fullscreen\.js\?v=20260924-8"><\/script>[\s\S]*<script src="ranked-client\.js\?v=20260924-22"><\/script>/);
