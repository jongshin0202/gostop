...
test('ten-second main-menu attract eligibility ignores stale gameplay dialogs but blocks account warnings',()=>{
  ...
  assert.match(ranked,/function mainMenuIdleEligible\(\)\{return !overlay\.hidden&&leaderboardScreen\.hidden&&onlinePanel\.hidden&&freePanel\.hidden&&!authDialog\.open&&!registrationPolicyDialog\.open&&!successDialog\.open&&!verificationDialog\.open&&!requestDialog\.open&&!accountNoticeDialog\.open&&!returnGameDialog\.open;\}/);
